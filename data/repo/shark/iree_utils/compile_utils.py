...
from repo.shark.iree_utils._common import iree_device_map, iree_target_map
...
def get_iree_device_args(device, extra_args=[]):
    ...
    if device_uri[0] == "cpu":
        from repo.shark.iree_utils.cpu_utils import get_iree_cpu_args
    ...
    if device_uri[0] in ["metal", "vulkan"]:
        from repo.shark.iree_utils.vulkan_utils import get_iree_vulkan_args

        return get_iree_vulkan_args(extra_args=extra_args)
    if device_uri[0] == "rocm":
        from repo.shark.iree_utils.gpu_utils import get_iree_rocm_args
