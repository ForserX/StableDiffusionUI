import os
from repo.shark.model_annotation import model_annotation, create_context
from repo.shark.iree_utils._common import iree_target_map, run_cmd
from repo.shark.shark_downloader import (
    download_model,
...
def load_model_from_tank():
    from repo.stable_diffusion.src.models import (
        get_params,
        get_variant_version,
    )
...
def load_lower_configs():
    from repo.stable_diffusion.src.models import get_variant_version
...
def annotate_with_lower_configs(
    ...
    device = get_device()
    if device == "cuda":
        from repo.shark.iree_utils.gpu_utils import get_iree_gpu_args
